...
#SBATCH --time=8:00:00
#SBATCH --job-name=xab
#SBATCH --output=/groups/umcg-gcc/tmp03/umcg-sli/development_eqtm/out/cpg_xab.out
#SBATCH --error=/groups/umcg-gcc/tmp03/umcg-sli/development_eqtm/out/cpg_xab.err
#SBATCH --mem=50gb
...
eqtmFile=${project_rootdir}/data/eqtmZscores/allCpgs/cpg_xab.txt
eqtmBedtoolsFile=${project_rootdir}/data/eqtmZscores/allCpgs/cpg_xab_bedtoolsFormat.txt
...
#    --input_type cpg_xab \
#    --cpg_filename cpg_xab_bedtoolsFormat.txt
#echo "Made all intersection files."

python ${project_rootdir}/tools/makeOverlapMatrix_significant.py \
    --input_dirname cpg_xab\
    --cpg_filename cpg_xab_bedtoolsFormat.txt\
    --original_eqtm_filepath ${project_rootdir}/data/eqtmZscores/allCpgs/cpg_xab.txt \
    --name cpg_xab
