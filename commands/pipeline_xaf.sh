...
#SBATCH --job-name=xaf
#SBATCH --output=/groups/umcg-gcc/tmp03/umcg-sli/development_eqtm/out/cpg_xaf.out
#SBATCH --error=/groups/umcg-gcc/tmp03/umcg-sli/development_eqtm/out/cpg_xaf.err
#SBATCH --mem=50gb
...
eqtmFile=${project_rootdir}/data/eqtmZscores/allCpgs/cpg_xaf.txt
eqtmBedtoolsFile=${project_rootdir}/data/eqtmZscores/allCpgs/cpg_xaf_bedtoolsFormat.txt
...
python ${project_rootdir}/tools/create_bedtoolsIntersect_files.py \
    ...
    --input_type cpg_xaf \
    --cpg_filename cpg_xaf_bedtoolsFormat.txt
echo "Made all intersection files."

python ${project_rootdir}/tools/makeOverlapMatrix_significant.py \
    --input_dirname cpg_xaf\
    --cpg_filename cpg_xaf_bedtoolsFormat.txt\
    --original_eqtm_filepath ${project_rootdir}/data/eqtmZscores/allCpgs/cpg_xaf.txt \
    --name cpg_xaf
