...
if __name__=='__main__':
    ...
    data_folder = os.path.join(PROJECT_DIR,'data','temp',
                               'features','2017-12-09-eQTLsFDR-et0.0-flipped')
    cpg_path = os.path.join(PROJECT_DIR,'data','eqtmZscores','2017-12-09-eQTLsFDR-et0.0-flipped.txt')
    feature_folder = '/groups/umcg-bios/tmp03/projects/2018-methylation/input/features/Roadmap/consolidatedImputedGappedPeak'
    save_path = os.path.join(PROJECT_DIR,'data','output','2017-12-09-eQTLsFDR-et0.0-flipped','2017-12-09-eQTLsFDR-et0.0-flipped_overlapMatrix.txt')
    ratio_table_savepath = os.path.join(PROJECT_DIR,'data','output','2017-12-09-eQTLsFDR-et0.0-flipped','2017-12-09-eQTLsFDR-et0.0-flipped_overlapRatio.txt')
