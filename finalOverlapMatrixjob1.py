...
if __name__=='__main__':
    ...
    data_folder = os.path.join(PROJECT_DIR,'data','temp',
                               'features','random20k_gt0.05_sm0.1')
    cpg_path = os.path.join(PROJECT_DIR,'data','eqtmZscores','random20k_gt0.05_sm0.1.txt')
    feature_folder = '/groups/umcg-bios/tmp03/projects/2018-methylation/input/features/Roadmap/consolidatedImputedGappedPeak'
    save_path = os.path.join(PROJECT_DIR,'data','output','random20k_gt0.05_sm0.1','random20k_gt0.05_sm0.1_overlapMatrix.txt')
