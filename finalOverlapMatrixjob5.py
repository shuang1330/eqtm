...
if __name__=='__main__':
    ...
    cpg_name = 'random20k_gt0.4_sm0.5' # probably the only thing needs changing
    ...
    data_folder = os.path.join(PROJECT_DIR,'data','temp',
                               'features',cpg_name)
    cpg_path = os.path.join(PROJECT_DIR,'data','eqtmZscores',
                            cpg_name+'.txt')
    ...
    for filename in os.listdir(data_folder)[:5]:
