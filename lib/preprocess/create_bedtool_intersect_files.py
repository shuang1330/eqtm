...
def overlapMatrixPipeline(dirs,
                          execute_bedtoolFilename):
    feature_list = readFeatureList(dirs)
    histone_list = readHistoneList(dirs.temp_meta,
                                   dirs.histone_list_filename,
                                   feature_list)
    cell_list = readCellList(dirs.temp_meta,
                             dirs.cell_list_filename,
                             feature_list)
