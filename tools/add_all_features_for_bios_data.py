...
def add_gene_meanVar(eqtm, gene_meanVar_filepath):
    ...
    eqtm["expressionMean"] = [gene_meanVar[gene][2] for gene in eqtm["ProbeName"]]
    eqtm["expressionVar"] = [gene_meanVar[gene][3] for gene in eqtm["ProbeName"]]
    print(eqtm.shape, eqtm.head())
    return eqtm
...
def add_methy_meanVar(eqtm, methy_meanVar_filepath):
    ...
    eqtm["methyMean"] = [methy_meanVar[gene][2] for gene in eqtm["SNPName"]]
    eqtm["methyVar"] = [methy_meanVar[gene][3] for gene in eqtm["SNPName"]]
    print(eqtm.shape, eqtm.head())
    return eqtm
...
if __name__ == "__main__":
    ...
    for name in ["eqtms_biosComplete_sig", "eqtms_biosComplete_between0.05_0.5", "eqtms_biosComplete_insig"]:
        print(name)
        ...
        cpg_overlapRatio_filepath = "/groups/umcg-gcc/tmp03/umcg-sli/development_eqtm/data/eqtmZscores" \
                                    "/allCpgs/cpg_biosComplete_overlapRatio.txt"
        ...
        gene_meanVar_filepath = "/groups/umcg-gcc/tmp03/umcg-sli/development_eqtm/data/features/meanVar/expression-MeanAndVarianceRows.txt"
        methy_meanVar_filepath = "/groups/umcg-gcc/tmp03/umcg-sli/development_eqtm/data/features/meanVar/methylation-MeanAndVarianceRows.txt"
